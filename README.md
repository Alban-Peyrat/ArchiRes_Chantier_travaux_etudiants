...
|CESP|CESP (Certificat d'études supérieures paysagères)|`HTYP1000B`|Mémoire pour obtenir le Certificat d'études supérieures paysagères (CESP), formation professionnalisante en conception du paysage, enseignée à l'Ecole nationale supérieure de paysage (Versailles et Marseille). |
|DPEA|DPEA (Diplôme propre aux ENSA)|`HTYP1000A`|Mémoire pour obtenir un diplôme de spécialisation aux études d'architecture, équivalent à un master spécialisé (sur bac+3)|

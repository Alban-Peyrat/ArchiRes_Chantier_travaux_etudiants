...
|DSA|DSA (Diplôme de spécialisation et d'approfondissement)|Mémoire pour obtenir un diplôme de spécialisation et d'approfondissement d'arhitecture (sur bac+5)|
...
|TPFE|TPFE (Travail personnel de fin d'études)|Le TPFE  permettait la délivrance du titre de DPLG ( diplômé par le gouvernement) pour l’architecte jusqu'en 2007 et pour le paysagiste jusqu'en 2019.|
|TATE|Travaux d'ateliers|_(anciens Travaux d'étudiants)_ Productions d'étudiants et/ou d'enseignants au sein d'un atelier/cours/workshop|
